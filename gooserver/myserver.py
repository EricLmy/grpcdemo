    ...
    def handle_rpc(self):
        while True:
            ...
            if len(length_prefix) < 4:
                break
            length, = struct.unpack("I", length_prefix.encode())
...
class RPCServer(asyncore.dispatcher):
    ...
    def register_zk(self):
        self.zk = KazooClient(hosts='192.168.1.16:2181')
        self.zk.start()
    ...
    def exit_parent(self, sig, frame):
        ...
        for pid in self.child_pids:
            ...
            try:
                ...
                if ex.args[0] == errno.ECHILD: # 子进程已经提前挂了
                    continue
                raise ex
        ...
        for pid in pids:
            while True:
                try:
                    ...
                    if ex.args[0] == errno.ECHILD: # 子进程已经收割了
                        break
