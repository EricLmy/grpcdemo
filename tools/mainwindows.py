...
class MainWindow(QMainWindow):
    ...
    def createActions(self):
        self.demo1Act = QAction(QIcon('./image/xiaob.jpg'), "demo1", self,
                statusTip="demo1 windows", triggered=self.demo1w)
    ...
    def createMenus(self):
        ...
        self.fileMenu.addAction(self.demo1Act)
    ...
    def createToolBars(self):
        ...
        self.fileToolBar.addAction(self.demo1Act)
